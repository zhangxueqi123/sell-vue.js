  ...
  <div v-show="showFlag" class="food" transition="move" v-el:food>
    <div class="food-content">
      ...
      <div class="content">
        ...
        <div @click.stop.prevent="addFirst($event)" transition="fade" class="buy" v-show="!food.count || food.count===0">加入购物车
        </div>
      </div>
      ...
      <div class="rating">
        ...
        <ratingselect :select-type="selectType" :only-content="onlyCount"
